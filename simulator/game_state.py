class GameState(dict):
    ...
    def _calculate_pct_game_played(self):
        ...
        return (3600 - self['seconds_remaining']) / 3600 if self['seconds_remaining'] is not None else 0
    ...
    @property
    def score_diff(self):
        return self._derived['score_diff']

    @property
    def pct_game_played(self):
        return self._derived['pct_game_played']

    @property
    def diff_time_ratio(self):
        return self._derived['diff_time_ratio']
